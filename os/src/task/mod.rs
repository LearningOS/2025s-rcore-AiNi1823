...
use crate::config::{MAX_APP_NUM,MAX_CALL_NUM};
        ...
        TaskManager {
            ...
            inner: unsafe {
                UPSafeCell::new(TaskManagerInner {
                    tasks,
                    current_task: 0,// Initialize the task call number array
                })
            },
        }
    };
...
/// Add syscall number to the current task
